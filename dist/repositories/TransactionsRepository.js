...
var TransactionsRepository = /** @class */ (function (_super) {
    ...
    TransactionsRepository.prototype.getBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var transactions, _a, income, outcome, total;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.find()];
                    case 1:
                        transactions = _b.sent();
                        _a = transactions.reduce(function (accumulator, transaction) {
                        ...
                        return [2 /*return*/, { income: income, outcome: outcome, total: total }];
                }
            });
        });
    };
