...
var CreateTransactionService = /** @class */ (function () {
    ...
    CreateTransactionService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var transactionRepository, categoryRepository, total, transactionCategory, transaction;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (type === 'outcome' && total < value) {
                            throw new AppError_1.default('You do not have enough balance.');
                        }
                    ...
                    case 2:
                        transactionCategory = _b.sent();
                        if (!!transactionCategory) return [3 /*break*/, 4];
                        transactionCategory = categoryRepository.create({ title: category });
                        return [4 /*yield*/, categoryRepository.save(transactionCategory)];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4:
...
//# sourceMappingURL=CreateTransactionService.js.map