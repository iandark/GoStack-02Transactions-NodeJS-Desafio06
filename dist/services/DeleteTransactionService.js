            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, transactionsRepository.findOne(id)];
                    case 1:
                        transaction = _a.sent();
                        if (!transaction) {
                            throw new AppError_1.default('Transaction does not exist');
                        }
                        return [4 /*yield*/, transactionsRepository.remove(transaction)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
...
//# sourceMappingURL=DeleteTransactionService.js.map