...
var ImportTransactionsService = /** @class */ (function () {
    ...
    ImportTransactionsService.prototype.execute = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionsRepository, categoriesRepository, contactsReadStream, parsers, parseCSV, transactions, categories, existentCategories, existentCategoriesTitles, addCategoryTitles, newCategories, finalCategories, createdTransactions;
            var _this = this;
                    ...
                    case 0:
                        ...
                        parseCSV.on('data', function (line) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                _a = line.map(function (cell) {
                                    return cell.trim();
                                }), title = _a[0], type = _a[1], value = _a[2], category = _a[3];
                                if (!title || !type || !value || !category)
                                    return [2 /*return*/];
                                categories.push(category);
                                transactions.push({ title: title, type: type, value: value, category: category });
                                return [2 /*return*/];
                            });
                        }); });
...
//# sourceMappingURL=ImportTransactionsService.js.map